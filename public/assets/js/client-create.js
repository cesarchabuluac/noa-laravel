...
/*!**********************************************!*\
  !*** ./resources/assets/js/client-create.js ***!
  \**********************************************/
 // Select2
...
function selectCountry(country) {
  ...
  if (country.element.value.toLowerCase() !== 'def') {
    var $country = $('<span><img src="http://127.0.0.1:8000/assets/images/flags/' + country.element.value.toLowerCase() + '.svg" class="br-5 avatar-sm" /> ' + country.text + '</span>');
    return $country;
  }
}
...
function showPassword() {
  ...
  var inputMain = document.querySelector('.input-password');
  var eyeOpenIcon = document.querySelector('.eye-open');
  var eyeCloseIcon = document.querySelector('.eye-close');
