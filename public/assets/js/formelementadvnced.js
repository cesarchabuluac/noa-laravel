...
/*!***************************************************!*\
  !*** ./resources/assets/js/formelementadvnced.js ***!
  \***************************************************/
...
$(function (e) {
  ...
  function select2Style1(data) {
    ...
    var $data = $('<span><img src="http://127.0.0.1:8000/assets/images/users/' + data.element.value.toLowerCase() + '.jpg" class="rounded-circle avatar-sm" /> ' + data.text + '</span>');
    return $data;
  }
