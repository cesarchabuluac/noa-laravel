...
(function ($) {
  ...
  if (bodyhorizontal) {
    ...
    localStorage.setItem("horizantal", "True"); // To enable no-wrap horizontal style

    $('#slide-left').removeClass('d-none');
    $('#slide-right').removeClass('d-none'); // To enable wrap horizontal style
  ...
  var bodyhorizontal1 = $('body').hasClass('horizontal-hover');
  ...
  if (bodyhorizontal1) {
    ...
    $('body').removeClass('closed-leftmenu');
    $('body').removeClass('hover-submenu');
    $('body').removeClass('hover-submenu1'); // To enable no-wrap horizontal style

    $('#slide-left').addClass('d-none');
    $('#slide-right').addClass('d-none'); // To enable wrap horizontal style
    // $('#slide-left').addClass('d-none');
    // $('#slide-right').addClass('d-none');
    // document.querySelector('.horizontal .side-menu').style.flexWrap = 'wrap'
...
function like() {
  ...
  like.forEach(function (element, index) {
    element.addEventListener('click', function () {
      ...
      console.log(Number(likeText[0].childNodes[2])); // likeText.innerText++
    });
  });
}

like(); // OFF-CANVAS STYLE
