...
/*!******************************************!*\
  !*** ./resources/assets/js/task-edit.js ***!
  \******************************************/
...
function selectClient(client) {
  ...
  var $client = $('<span><img src="http://127.0.0.1:8000/assets/images/users/' + client.element.value.toLowerCase() + '.jpg" class="rounded-circle avatar-sm ms-1" /> ' + client.text + '</span>');
  return $client;
}
...
var noTaskEndDateCheckboxContainer = document.querySelector('.no-taskEnd-checkbox-container');
var noTaskEndDateCheckbox = document.querySelector('.no-taskEnd-date-checkbox');
var taskEndDateContainer = document.querySelector('.task-endDate-container');
...
var noSubtaskEndDateCheckboxContainer = document.querySelector('.no-subtaskEnd-checkbox-container');
var noSubtaskEndDateCheckbox = document.querySelector('.no-subtaskEnd-date-checkbox');
var subtaskEndDateContainer = document.querySelector('.subtask-endDate-container');
...
showAndHideOtherDetails(); //display dependent task
